...
public class SA_Debug_Log extends SA_Obj{
    ...
    public SA_Debug_Log(String name, Object parent) {
        ...
        SA_Draw_Camera_SpriteCenter("위쪽화살표버튼", "car", 10, 0, 0, SA_CAMERA_CENTERX, SA_CAMERA_CENTERY, 50, 50);
        SA_Draw_Camera_RectCenter("사각형버튼", 9, SA_EDGE, SA_CAMERA_CENTERX, SA_CAMERA_CENTERY, 100, 10, SA_COLOR_BLACK, 3);
